...
(function() {
    ...
    emailjs.init('gxhTsmR_JJExiw3KX');
})();
...
if (contactForm) {
    contactForm.addEventListener('submit', function(e) {
        ...
        const templateParams = {
            ...
            subject: subject,
            message: message,
            to_email: 'yijo@umich.edu' // Your email address
        };
        
        // Send email using EmailJS
        emailjs.send('service_30424ff', 'template_t0hr4qm', templateParams)
...
// Update navbar styling based on theme and scroll position
...
updateNavbarStyling(); // Initialize navbar styling
...
themeToggle.addEventListener('click', () => {
    ...
    updateNavbarStyling(); // Update navbar styling immediately
});
